                                ...
                                <form method="post" action="{{route('blog.store')}}">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="textfa" class="form-control" id="text" required>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="text">متن (انگلیسی)<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="texten" class="form-control" id="text" required
                                                           style="direction: ltr">
                                                </div>
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="text">متن (ترکی)<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="texttur" class="form-control" id="text" required
                                                           style="direction: ltr">
                                                </div>
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                        <button type="submit" class="theme-btn btn-style-one"
                                                ...
                                                class="btn-title">ثبت</span></button>
                                    </div>
                                </form>
