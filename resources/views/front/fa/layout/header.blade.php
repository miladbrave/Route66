                    ...
                    <nav class="main-menu navbar-expand-lg navbar-light">
                        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                <li id="home"><a href="{{route('home')}}">خانه</a></li>
                                <li id="service"><a href="{{route('service')}}">خدمات</a></li>
                                <li id="estate"><a href="{{route('list')}}">لیست املاک</a></li>
                                <li id="estate"><a href="{{route('carlist')}}">لیست خودروها</a></li>
                                <li id="about"><a href="{{route('about')}}">درباره ما</a></li>
                                <li id="contact"><a href="{{route('contact')}}">تماس با ما</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="nav-outer clearfix col-md-8">--}}
{{--                    <!--Mobile Navigation Toggler-->--}}
{{--                    <div class="mobile-nav-toggler"><span class="icon flaticon-menu"></span></div>--}}
...
{{--                                <li id="service"><a href="{{route('service')}}">خدمات</a></li>--}}
{{--                                <li id="estate"><a href="{{route('list')}}">لیست املاک</a></li>--}}
{{--                                <li id="blog"><a href="{{route('blog')}}">وبلاگ</a></li>--}}
{{--                                <li id="contact"><a href="{{route('contact')}}">تماس با ما</a></li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </nav>--}}
