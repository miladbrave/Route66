    ...
    <div class="page-wrapper">
                    ...
                    <div class="image-column col-xl-4 col-lg-12 col-md-12 col-sm-12">
                        <div class="image-box">
                            <figure class="image"><img
                                        ...
                                        data-src="/front/images/resource/image-2.jpg" alt=""></figure>
                        </div>
                    </div>
        ...
        <section class="agents-section-two alternate">
            <div class="auto-container">
                <div class="sec-title text-center">
                    <div class="devider"><span></span></div>
                    <h2>Danışmanlarımızla tanışın</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="content-column col-lg-7 col-md-12 col-sm-12">
                                        <div class="inner-column clearfix">
                                            <h3 class="name text-left">{{$agent->turname}}</h3>
                                            <span class="designation text-left">Danışman - Emlak</span>
