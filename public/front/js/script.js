...
$(".language").change(function () {
   let select = $('.language').val();

    if (window.location.href.indexOf("en") > -1) {
       let url = window.location.href.replace("en",select);
        window.location.href = url;
    }
    if (window.location.href.indexOf("fa") > -1) {
        let url = window.location.href.replace("fa",select);
        window.location.href = url;
    }
    if (window.location.href.indexOf("tr") > -1) {
        let url = window.location.href.replace("tr",select);
        window.location.href = url;
    }
});
